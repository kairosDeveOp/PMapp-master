...
{
    public class PastTenantsViewComponent: ViewComponent
    {
        private readonly ApplicationDbContext _context;

        public PastTenantsViewComponent(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var tenants = from t in _context.Tenant
                          where t.Current.Equals("No")
